          ...
          {tiffins.map((product) => {
            return (
              <Card sx={{ maxWidth: "350px", mb: 2 }}>
                ...
                <Rating mt={product.rating} />
                <Typography ml={20}>{product.cat}</Typography>
                <CardContent>
                  <Typography variant="h5">{product.brand}</Typography>
                  <Typography variant="h5">{product.rating}</Typography>
                  <Typography variant="h5">{product.discount}</Typography>
                  <Typography variant="h5">{product.one_day}</Typography>
