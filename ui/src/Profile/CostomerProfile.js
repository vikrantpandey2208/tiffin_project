  ...
  return (
    ...
    <Grid container>
          <Paper elevation={10} style={paperStyle} >
            <Typography ml={12} variant='h4'  style={{color:'white' ,backgroundColor:"#ff386a", width:'40%',borderRadius:'5px', align:'center'}} ><ManageAccountsIcon/>Profile</Typography><br/>
            {/* First Name */}
              <div >
              <Typography variant="h5" style={{color:'white' ,backgroundColor:"#ff386a", width:'40%',borderRadius:'5px'}}>First name</Typography>
                  {!isFirstNameFocused ? (        
                    <Typography 
                    style={fontStyle}        
                      onClick={() => {
            ...
            {/* LastName */}
            <div >
              <Typography variant="h5" style={{color:'white' ,backgroundColor:"#ff386a", width:'40%',borderRadius:'5px'}}>Last name</Typography>
                  {!isLastNameFocused ? (        
                    <Typography 
                    style={fontStyle}        
                      onClick={() => {
            ...
            {/* Email adress */}
            <div >
              <Typography variant="h5" style={{color:'white' ,backgroundColor:"#ff386a", width:'40%',borderRadius:'5px'}}>Email</Typography>
                  {!isEmailFocused ? (        
                    <Typography 
                    style={fontStyle}        
                      onClick={() => {
            ...
            <br/>
            <Grid ml={15}>
            <Button variant="contained" component="label" onClick={handleSave}>{save}</Button>   
